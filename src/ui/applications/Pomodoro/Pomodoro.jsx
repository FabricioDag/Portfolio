...
const Pomodoro = () =>{
    ...
    return(
        <div className={`${style.Pomodoro} application ` }>
            ...
            <h3>Pomodoro</h3>
            <p>currentTimer: {currentTimer} currentCycle: {cycleCount}</p>

            <div className={style.actualTimer}>
                <p className={`${currentTimer == 'work'? style.actual : ''}`}>Pomodoro</p>
            ...
            <div className={style.timerWrapper} onClick={handleClick}>
                ...
                <div className={style.nextTimer}>
                    <p>{`${currentTimer!=='work'? (workTime/60) : cycleCount<(cyclesBeforeLongBreak) ? (shortBreakTime/60) : (longBreakTime/60) }`}</p>
                </div>
            </div>
